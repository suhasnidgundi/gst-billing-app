...
import com.svcp.gstbillingapp.utils.NumberToWord;
import com.svcp.gstbillingapp.utils.PDFUtils;
...
public class SavePDFActivity extends AppCompatActivity {
    ...
    private static final int SAVE_PDF_DELAY = 1000; // milliseconds in int
