...
import com.svcp.gstbillingapp.utils.PriceUtils;
...
public class DetailAdapter extends RecyclerView.Adapter<DetailAdapter.DetailHolder> {
    ...
    public void onBindViewHolder(DetailHolder holder, int position) {
        if(mCursor.moveToPosition(position)){
            ...
            holder.taxSlab.setText(taxSlabValue + "%");
            ...
            totalAmount += (finalPriceValue*quantityValue+singleGstValue*2);
    ...
    public class DetailHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
        ...
        private final MenuItem.OnMenuItemClickListener onEditItemMenu = new MenuItem.OnMenuItemClickListener() {
            @Override
